...
bool ManipulateValve::executePointTrajectory(geometry_msgs::PoseStamped& temp_pose, std::string planning_group, moveit_msgs::RobotTrajectory& robot_traj)
{
...
bool ManipulateValve::reachToManipulate(const geometry_msgs::PoseStamped& valve_center_pelvis, const float radius,
                                        RobotSide side)
{
...
double ManipulateValve::rotateValve(const std::vector<geometry_msgs::Pose>& pose_vec, RobotSide side)
{
  moveit_msgs::RobotTrajectory robot_traj;
  std::string planning_group =
      (side == RobotSide::LEFT) ? TOUGH_COMMON_NAMES::LEFT_ARM_7DOF_GROUP : TOUGH_COMMON_NAMES::RIGHT_ARM_7DOF_GROUP;
...
void ManipulateValve::getCircularTrajectoryVector(std::vector<geometry_msgs::Pose> &pose_vec, const geometry_msgs::PoseStamped valve_center_pelvis, const float radius,
...
bool ManipulateValve::retractHand(const geometry_msgs::PoseStamped& valve_center_pelvis, const float radius, RobotSide side,
...
void ManipulateValve::operateValve(const geometry_msgs::PoseStamped& valve_center, const float radius,
                                   RobotSide side, const float rotations)
{
